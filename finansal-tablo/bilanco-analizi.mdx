...
description: "Bir şirket finansal rapor bildirimi yaptığında ilk bakmamız gereken tablolar bilanço, gelir tablosu ve nakit akım tablosudur. Bu yazımızda bu tablolardan bilançonun analizinin nasıl yapılacağını işleyeceğiz."
---
